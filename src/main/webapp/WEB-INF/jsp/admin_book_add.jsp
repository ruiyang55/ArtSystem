...
<div style="position: relative;padding-top: 60px; width: 80%;margin-left: 10%">
    <form action="book_add_do.html" method="post" id="addbook">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="name" id="name" placeholder="请输入艺术品名称">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="publish">出版公司</label>
            <input type="text" class="form-control" name="publish" id="publish" placeholder="请输入出版公司">
        </div>
        <div class="form-group">
            <label for="isbn">艺术品编号</label>
            <input type="text" class="form-control" name="isbn" id="isbn" placeholder="请输入艺术品编号">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="language">地区</label>
            <input type="text" class="form-control" name="language" id="language" placeholder="请输入地区">
        </div>
        <div class="form-group">
            <label for="price">预估行价</label>
            <input type="text" class="form-control" name="price" id="price" placeholder="请输入预估行价">
        </div>
        <div class="form-group">
            <label for="pubstr">展出日期</label>
            <input type="date" class="form-control" name="pubstr" id="pubstr" placeholder="请输入展出日期">
        </div>
        <div class="form-group">
